...
if(isset($_GET["id"]) && is_numeric($_GET["id"])){
    $formulario->setVariable("titulo_formulario","Editar Archivo");
    $formulario->setVariable("accion","curso/archivo/editar.php");
    include_once(dirname(__FILE__)."/mostrar.php");
}else{
    $formulario->setVariable("titulo_formulario","Nuevo Archivo");
    ...
    $formulario->setVariable("accion","curso/archivo/guardar.php");
}
...
if(isset($_GET["msg"]))
{
    switch ($_GET["msg"]){
        ...
        break;
        case 5:
            $formulario->setVariable("mensaje_error","<b>Error:</b> El tama&ntilde;o del archivo es demasiado grande.") ; 
        break;
    };
}
