...
if(isset($_GET["id"]) && is_numeric($_GET["id"])){
    $formulario->setVariable("titulo_formulario","Editar Imagen");
    $formulario->setVariable("accion","curso/imagen/editar.php");
    include_once(dirname(__FILE__)."/mostrar.php");
}else{
    $formulario->setVariable("titulo_formulario","Nueva Imagen");
    ...
    $formulario->setVariable("accion","curso/imagen/guardar.php");
}
