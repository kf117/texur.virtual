...
if(isset($_GET["id"]) && is_numeric($_GET["id"])){
    $formulario->setVariable("titulo_formulario","Editar Video");
    $formulario->setVariable("accion","curso/video/editar.php");
    include_once(dirname(__FILE__)."/mostrar.php");
}else{
    $formulario->setVariable("titulo_formulario","Nuevo Video");
	if(isset($_SESSION["campos"])){
		$formulario->setVariable("nombre",htmlspecialchars($_SESSION["campos"]["nombre"]));
                ...
                $formulario->setVariable("video",$_SESSION["campos"]["video"]);
    ...
    $formulario->setVariable("accion","curso/video/guardar.php");
}
