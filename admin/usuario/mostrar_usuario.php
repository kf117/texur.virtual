...
if(isset($_GET["msg"]))
{
    switch ($_GET["msg"]){
        case 1:
            $modificar->setVariable("mensaje_error","<b>Error:</b> Passwords no coinciden.") ; 
        break;
        case 2:
            $modificar->setVariable("mensaje_error","<b>Error:</b> El password actual no es correcto.") ; 
        break;
        case 3:
            $modificar->setVariable("mensaje_exito","<b>Exito:</b> Los cambios han sido guardados correctamente.") ; 
        break;
        case 4:
            $modificar->setVariable("mensaje_error","<b>Error:</b> Los campos requeridos no pueden estar vacios.") ; 
        break;
