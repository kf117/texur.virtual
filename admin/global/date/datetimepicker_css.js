...
var MonthYearColor = "#518AB5"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#878687"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#D8D7D8"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#D8D7D8"; //Background color of Saturday.
var WeekDayColor = "#EEEAEE"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#8DDFFD"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#8DDFFD"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#A1CAD9"; //color when mouse move over.
...
var imageFilesPath = "./global/date/";
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.Scroller === "DROPDOWN")
	{
		...
		//Year selector
                ...
                /*var tmpYear = 0;
                if(Cal.EnableDateMode === "plus18"){
                    tmpYear = Cal.Year;
                    Cal.Year = Cal.Year - 18;
                }*/

		vCalHeader += "<td align='center'><select name='YearSelector' id='plus18' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
	...
	{
		Cal.Format = "DDMMYYYY"; // SE modifico formato aca era MMDDYYY
	}
    ...
    if (pEnableDateMode !== undefined && (pEnableDateMode === "future" || pEnableDateMode === "past" || pEnableDateMode === "plus18")) {
